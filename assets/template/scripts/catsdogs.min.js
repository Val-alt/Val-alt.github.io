...
var className,classNameForJQ,translationBreeds,engBreeds,itemId,itemObj,arrPreviousImage,engCatBreeds={},engCatsObj=[];className=$("body").attr("class"),classNameForJQ="."+className+" ";var App={options:{},init:function(){this.animateLine(),this.loadingBreeds(),this.btnLeftRight()},animateLine:()=>{let e,a;a="0px",$(window).width()>"1234"?e="600px":$(window).width()>"646"?e="280px":$(window).width()<="575"&&(e="200px"),$(".option__btn").mouseenter(function(){$(this).find(".option__line").animate({width:e},250)}),$(".option__btn").mouseleave(function(){$(this).find(".option__line").animate({width:"0px"},250)})},getKeyByValue:(e,a)=>Object.keys(e).find(t=>e[t]===a),loadingBreeds:()=>{"main-dogs"===className&&$.getJSON("https://dog.ceo/api/breeds/list/all").then(e=>engBreeds=Object.keys(e.message)).then(e=>{translationBreeds={waterdog:"водяная собака",papillon:"папильён",african:"африканская",cattledog:"пастушья собака",cotondetulear:"котон-де-тулеар",entlebucher:"энтлебухер",eskimo:"эскимосская собака",germanshepherd:"немецкая овчарка",mexicanhairless:"ксолоитцкуинтли",mountain:"зенненхунд",pointer:"пойнтер",pug:"мопс",puggle:"пагль",redbone:"редбон кухаунд",shihtzu:"ши-тцу",stbernard:"сербернар"};for(let a=0;a<e.length;a++){let t=e[a];translationBreeds[t]||App.translateBreeds(t,e)}}).catch(e=>{$(classNameForJQ+"#content").html("не удалось перевести породы собачек")}),"main-cats"===className&&$.getJSON("https://api.thecatapi.com/v1/breeds").then(e=>{let a=e.map(e=>e.origin),t=e.map(e=>e.life_span),s=e.map(e=>e.name),i=e.map(e=>e.id),r=e.map(e=>e.adaptability),l=e.map(e=>e.affection_level),n=e.map(e=>e.child_friendly),o=e.map(e=>e.dog_friendly),c=e.map(e=>e.energy_level),m=e.map(e=>e.grooming),d=e.map(e=>e.health_issues),p=e.map(e=>e.intelligence),h=e.map(e=>e.shedding_level),g=e.map(e=>e.social_needs),b=e.map(e=>e.stranger_friendly),f=e.map(e=>e.vocalisation),$=e.map(e=>e.experimental),u=e.map(e=>e.rare),N=e.map(e=>e.hairless),v=e.map(e=>e.suppressed_tail),y=e.map(e=>e.short_legs);for(let e=0;e<s.length;e++)engCatBreeds[s[e]]=i[e],engCatsObj[e]={name:s[e],id:i[e],origin:a[e],life_span:t[e],adaptability:r[e],affection_level:l[e],child_friendly:n[e],dog_friendly:o[e],energy_level:c[e],grooming:m[e],health_issues:d[e],intelligence:p[e],shedding_level:h[e],social_needs:g[e],stranger_friendly:b[e],vocalisation:f[e],experimental:$[e],rare:u[e],hairless:N[e],suppressed_tail:v[e],short_legs:y[e]};return engCatBreeds}).then(e=>{translationBreeds={Cheetoh:"чито"};for(let a=0;a<Object.keys(e).length;a++){let t=Object.keys(e)[a];translationBreeds[t]||App.translateBreeds(t,e)}}).catch(e=>{$(classNameForJQ+"#content").html("не удалось перевести породы кошечек")})},translateBreeds:(e,a)=>{$.getJSON("https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20190118T073029Z.3f310cb0cd1394d9.52268319f275afdd6bc274241581fc691aa64ccd&text="+e+"&lang=en-ru").then(t=>{let s=t.text[0].toLowerCase();if(translationBreeds[e]=s,Object.keys(translationBreeds).length===Object.keys(a).length){let e,a=Object.values(translationBreeds).sort(),t="";$(classNameForJQ+".spinner-border.load-breed").hide(),$(classNameForJQ+".breeds-dropdown .dropdown-toggle").html('cписок пород <i class="fas fa-check ml-2"></i>'),$(classNameForJQ+".fa-check").fadeOut(600);for(let e of a)t+='<button class="dropdown-item breed-dropdown-item" type="button" value="'+App.getKeyByValue(translationBreeds,e)+'">'+e+"</button>";$(".text-to-find").prop("disabled",!1),$(classNameForJQ+".breeds-select").html(t),"main-cats"===className&&(e=engCatBreeds),App.clickDropdown(e),App.searchBreed(translationBreeds)}})},clickDropdown:e=>{$(classNameForJQ+"button.breed-dropdown-item").on("click",function(){arrPreviousImage=[];let e=$(this).html(),a=$(this).val();"main-dogs"===className&&(itemId=a),"main-cats"===className&&(itemId=engCatBreeds[a],itemObj=engCatsObj.find(e=>e.name===a)),App.pictBreed(itemId,e,itemObj)})},pictBreed:(e,a,t)=>{let s;$(classNameForJQ+".load-pict-breed.spinner-border").show(),"main-dogs"===className?s="https://dog.ceo/api/breed/"+e+"/images/random":"main-cats"===className&&(s="https://api.thecatapi.com/v1/images/search?breed_ids="+e),$.getJSON(s).then(e=>{let s;if($(classNameForJQ+".card-title").html(""),$(classNameForJQ+".card-title").html('Порода <span class="breed text-primary">'+a+"</span>"),"main-dogs"===className?s=e.message:"main-cats"===className&&(s=e[0].url),$(classNameForJQ+".load-pict-breed.spinner-border").hide(),$(classNameForJQ+"#content").html('<img class="img-fluid" src="'+s+'">'),"main-cats"===className){let e;for(var i in $(".characteristics").show(),e=($(window).width(),22),t)"life_span"==i?$(classNameForJQ+'div[data-param="'+i+'"]').html(t[i]):"name"!=i&&"id"!=i&&"origin"!=i&&$(classNameForJQ+'div[data-param="'+i+'"]').css("width",t[i]*e+"px")}arrPreviousImage.push($(classNameForJQ+"#content").html()),$(classNameForJQ+".btnLeft").prop("disabled",!0),$(classNameForJQ+".btnLeft").css("visibility","visible"),$(classNameForJQ+".btnRight").css("visibility","visible"),arrPreviousImage.length>1&&$(classNameForJQ+".btnLeft").prop("disabled",!1)}).catch(()=>{$(classNameForJQ+".load-pict-breed.spinner-border").hide(),$(classNameForJQ+"#content").html("не удалось загрузить картинку")})},btnLeftRight:()=>{$(".btnRight").on("click",()=>{let e=$(classNameForJQ+".breed").html();if(void 0===itemId)return!1;App.pictBreed(itemId,e,itemObj)}),$(".btnLeft").on("click",()=>{if(!(arrPreviousImage.length>1))return!1;$(classNameForJQ+"#content").html(""),$(classNameForJQ+"#content").html(arrPreviousImage[arrPreviousImage.length-2]),arrPreviousImage.pop(),arrPreviousImage.length<=1&&$(classNameForJQ+".btnLeft").prop("disabled",!0)})},searchBreed:e=>{let a,t;$(".text-to-find").keyup(function(s){s.preventDefault();let i=$(s.target).val();a=Object.values(e),t="";for(let s of a){i===s.substring(0,i.length)&&""!=i&&(t+="<li class='search__item'>"+s+"</li>",$(classNameForJQ+".search").css("display","block"),$(classNameForJQ+".search__items").html(t),$(".search__item").on("click",a=>{arrPreviousImage=[];let t=$(a.target).html(),s=App.getKeyByValue(e,t);"main-dogs"===className&&(itemId=s),"main-cats"===className&&(itemId=engCatBreeds[s],itemObj=engCatsObj.find(e=>e.name===s)),App.pictBreed(itemId,t,itemObj),$(classNameForJQ+".text-to-find").val("")}))}if(""==i&&(t="",$(classNameForJQ+".search__items").html(t),$(classNameForJQ+".search").css("display","none")),$(document).on("click",e=>{$(classNameForJQ+".text-to-find").is(e.target)||(t="",$(classNameForJQ+".search__items").html(t),$(classNameForJQ+".search").css("display","none"))}),27==s.keyCode&&(this.value="",t="",this.value="",$(classNameForJQ+".search").css("display","none")),13==s.keyCode&&(i.length<4&&(alert("Введите четыре или более символов"),this.value="",$(classNameForJQ+".search").css("display","none")),i.length>=4)){if(/[a-z\s]/i.test($(this).val()))alert("Некорректный ввод"),this.value="";else if(App.getKeyByValue(e,i)){arrPreviousImage=[];let a=App.getKeyByValue(e,i),t=i;"main-dogs"===className&&(itemId=a),"main-cats"===className&&(itemId=engCatBreeds[a],itemObj=engCatsObj.find(e=>e.name===a)),App.pictBreed(itemId,t,itemObj),this.value="",$(classNameForJQ+".search").css("display","none")}else alert("Такой породы нет, попробуйте еще раз"),this.value=""}})}};$(document).ready(function(){App.init()});